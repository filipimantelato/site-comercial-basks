...
<body>
    ...
    <div class="corpoCadastroProdutos">
        ...
        <form action="../controller/atualizarProdutoController.php" class="form-cadastro-produtos" method="post">
            <input type="hidden" name="id" value="<?php echo $produto['id']; ?>"><br><br>
            <label for="nome">Nome: </label>
            <input type="text" name="nome" size="50" class="nome" value="<?php echo $produto['nome']; ?>" required><br><br>
            <label for="codigo">Código do Produto: </label>
            <input type="text" name="codigo" size="30" class="codigo" value="<?php echo $produto['codigo']; ?>" required><br><br>
            <label for="tamanho">Tamanho: </label>
            <input type="text" name="tamanho" size="30" class="tamanho" value="<?php echo $produto['tamanho']; ?>" required><br><br>
            <label for="quantidade">Quantidade: </label>
            <input type="number" name="quantidade" size="30" class="quantidade" value="<?php echo $produto['quantidade']; ?>" required><br><br><br>
            <input type="hidden" name="atualiza" value="produto">
