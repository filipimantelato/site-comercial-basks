...
<body>
    ...
    <div class="corpoCadastroProdutos">
        ...
        <form action="../controller/cadastrarCompraController.php" class="form-cadastro-produtos" method="post">
            <label for="codigoP">Código do Produto: </label>
            <input type="text" name="codigoP" size="30" class="nome" placeholder="XX00X" required><br><br>
            <label for="emailC">E-mail do Cliente: </label>
            <input type="text" name="emailC" size="30" class="codigo" placeholder="exemplo@gmail.com" required><br><br>
            <label for="data">Data da Compra: </label>
            <input type="date" name="data" size="30" class="data" required><br><br>
            <label for="qntd">Quantidade: </label>
            <input type="number" name="qntd" size="30" class="qntd" placeholder="Quantidade" required><br><br><br>
