    ...
    <div class="corpoCadastroProdutos">
        <?php
            ...
            if (isset($_SESSION['result'])) {
                ...
                echo '<p style="font-size: 20px; color:black;"> Nenhum produto encontrado!</p>';
            }
        ?>
        <br><br><a href="consultarProdutoView.php"><button class="botao"> < Voltar</button></a>
    </div>
