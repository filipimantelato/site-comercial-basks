...
<body>
    ...
    <div class="corpoCadastroProdutos">
        ...
        <form action="../controller/deletarCompraController.php" class="form-cadastro-produtos" method="post">
            <label for="idCompra">Id da Compra: </label>
            <input type="number" name="idCompra" size="30" class="id" placeholder="ID" required>
