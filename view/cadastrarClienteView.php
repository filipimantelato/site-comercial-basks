...
<body>
    ...
    <div class="corpoCadastroProdutos">
        ...
        <form action="../controller/cadastrarClienteController.php" class="form-cadastro-produtos" method="post">
            <label for="nome">Nome do Cliente: </label>
            <input type="text" name="nome" size="40" class="nome" placeholder="Nome Completo" required><br><br>
            <label for="email">Email do Cliente: </label>
            <input type="text" name="email" size="30" class="email" placeholder="exemplo@gmail.com" required><br><br>
            <label for="cpf">CPF do Cliente: </label>
            <input type="text" name="cpf" size="30" class="cpf" placeholder="000.000.000-00" required pattern="\d{3}.\d{3}.\d{3}.\d{2}" required><br><br>
            <label for="cep">CEP do Cliente: </label>
            <input type="text" name="cep" size="30" class="cep" placeholder="00000-000" required pattern="\d{5}-\d{3}" required><br><br><br>
