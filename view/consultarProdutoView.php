...
<body>
    ...
    <div class="corpoCadastroProdutos corpoConsultaProdutos">
        ...
        <form action="../controller/consultarProdutoController.php" class="form-cadastro-produtos" method="post">
            <label for="codigoP">Código do Produto: </label>
            <input type="text" name="codigoP" size="30" class="codigo" placeholder="XX00X" required>
            <input type="hidden" name="consulta" value="produto">
            <input type="submit" value="Consultar" class="botao"><br><br><br>
        </form>

        <?php
            require_once '../model/consultarProdutoModel.php';
            $consulta = new ConsultarProdutoModel();
            $result = $consulta->consultarTodosProdutos();
